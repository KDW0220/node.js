...
router.get('/register', function(req, res, next) {
  res.render('index', { title: '회원가입' ,pageName:'register.ejs',userid:req.session.userid});
});
...
router.post('/register',function(req,res){
  ...
  var sql="insert into tbl_user(id,pass,name) values(?,?,?)";
  db.get().query(sql,[id,pass,name],function(err, result){
